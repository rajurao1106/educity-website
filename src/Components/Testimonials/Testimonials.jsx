        ...
        <li>
                <div className="slide">
                    <div className="user-info">
                        ...
                        <p>Choosing to pursue my degree at edusity eas one of the best decisions i have ever made the supports community state of the art fasacailities and commitment to academanic have truly exceeded my expectation.</p>
                </div>
            </li>
            <li>
                <div className="slide">
